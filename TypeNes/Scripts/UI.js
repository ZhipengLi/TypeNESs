...
(function (NES) {
    var UI = (function () {
        function UI(nesMachine) {
            this.machine = nesMachine;
            this.screen = document.getElementById("nes-screen");
            this.status = document.getElementById("nes-status");
        ...
        UI.prototype.resetCanvas = function () {
        ...
        UI.prototype.updateStatus = function (s) {
            this.status.textContent = s;
        };
        UI.prototype.writeFrame = function (buffer, prevBuffer) {
